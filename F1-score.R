...
# We have been inspired by the following article for multi-class problems. By applying some changes to their computations, we can extract a function for computation of confidence interval of F1-Score in a binary classification
